...
{
    [PINRemoteImageCategoryManager setImageOnView:self fromURLs:@[url] placeholderImage:placeholderImage localImageName:localImageName processorKey:processorKey processor:processor completion:completion];
}
